...
#define SOFTWARE_SERIAL //uncomment this line to mirror the data to an external serial port, for instance 
                          //for sending the data to an ESP
...
void setup() {
   ...
   serialPort.begin(115200);
	while(!serialPort)
	{
		...
		delay(1000) ;
		Serial.println("Can't open serial port on  [5,6]!!");
	}
	#endif
#ifndef RAWMONITOR
